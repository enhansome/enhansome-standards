...
* [gRPC](https://github.com/grpc/grpc/blob/master/doc/PROTOCOL-HTTP2.md) ⭐ 45,252 | 🐛 1,382 | 🌐 C++ | 📅 2026-08-24 - This document serves as a detailed description for an implementation of gRPC carried over HTTP2 framing.
* [Microsoft REST API Guidelines](https://github.com/Microsoft/api-guidelines) ⭐ 23,324 | 🐛 176 | 📅 2026-08-05 - Repository contains a collection of documents and related materials.
...
* [Dart Design](https://github.com/dart-lang/language) ⭐ 2,932 | 🐛 1,323 | 🌐 TeX | 📅 2026-08-24 - Design of the Dart language.
...
* [OTEPs](https://github.com/open-telemetry/opentelemetry-specification/tree/main/oteps/) ⭐ 4,322 | 🐛 479 | 🌐 Makefile | 📅 2026-08-24 - OpenTelemetry Enhancement Proposals.
...
* [BOLTs](https://github.com/lightning/bolts) ⭐ 2,246 | 🐛 40 | 🌐 Markdown | 📅 2026-07-27 - Basis of Lightning Technology (Lightning Network Specifications).
...
* [HIPs](https://github.com/helium/HIP) ⭐ 588 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2026-08-24 - Helium Improvement Proposals.
