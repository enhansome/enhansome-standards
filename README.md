...
* [gRPC](https://github.com/grpc/grpc/blob/master/doc/PROTOCOL-HTTP2.md) ⭐ 45,284 | 🐛 1,346 | 🌐 C++ | 📅 2026-09-02 - This document serves as a detailed description for an implementation of gRPC carried over HTTP2 framing.
...
* [Apache Thrift](https://github.com/apache/thrift/tree/master/doc/specs) ⭐ 10,957 | 🐛 20 | 🌐 C++ | 📅 2026-09-02 - Interface Definition Language and binary communication protocol used for defining and creating services for programming languages.
* [CloudEvents Spec](https://github.com/cloudevents/spec) ⭐ 5,885 | 🐛 16 | 🌐 Python | 📅 2026-09-01 - A specification for describing event data in a common way.
...
* [Zig Proposals](https://github.com/ziglang/zig/issues?q=is:issue+is:open+label:proposal) ⭐ 43,315 | 🐛 2,827 | 🌐 Zig | 📅 2025-11-27 - Issues with Proposal label in Zig repository.
...
* [KEEP](https://github.com/Kotlin/KEEP) ⭐ 3,763 | 🐛 12 | 🌐 Markdown | 📅 2026-09-01 - Kotlin Evolution and Enhancement Process.
...
* [GHC Proposals](https://github.com/ghc-proposals/ghc-proposals) ⭐ 707 | 🐛 196 | 🌐 Python | 📅 2026-08-31 - Compiler and language changes for Haskell/GHC.
* [F# Design](https://github.com/fsharp/fslang-design) ⭐ 553 | 🐛 31 | 🌐 F# | 📅 2026-09-01 - F# Language Design RFCs.
...
* [OTEPs](https://github.com/open-telemetry/opentelemetry-specification/tree/main/oteps/) ⭐ 4,335 | 🐛 377 | 🌐 Makefile | 📅 2026-09-01 - OpenTelemetry Enhancement Proposals.
...
* [React Native RFCs](https://github.com/react-native-community/discussions-and-proposals) ⭐ 1,823 | 🐛 263 | 📅 2026-06-02 - React Native enhancement discussions.
...
* [LibP2P Specs](https://github.com/libp2p/specs) ⭐ 1,776 | 🐛 197 | 📅 2026-09-01 - Technical specifications for the libp2p networking stack.
...
* [Awesome Guidelines](https://github.com/Kristories/awesome-guidelines) ⭐ 11,081 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-28 - Coding style conventions and standards.
* [Awesome API Devtools](https://github.com/yosriady/awesome-api-devtools) ⭐ 4,016 | 🐛 46 | 📅 2025-12-20 - A collection of useful resources for building RESTful HTTP+JSON APIs.
