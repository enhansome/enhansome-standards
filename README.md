...
* [gRPC](https://github.com/grpc/grpc/blob/master/doc/PROTOCOL-HTTP2.md) ⭐ 45,279 | 🐛 1,386 | 🌐 C++ | 📅 2026-08-13 - This document serves as a detailed description for an implementation of gRPC carried over HTTP2 framing.
* [Microsoft REST API Guidelines](https://github.com/Microsoft/api-guidelines) ⭐ 23,319 | 🐛 176 | 📅 2026-08-05 - Repository contains a collection of documents and related materials.
...
* [Apache Thrift](https://github.com/apache/thrift/tree/master/doc/specs) ⭐ 10,951 | 🐛 13 | 🌐 C++ | 📅 2026-08-12 - Interface Definition Language and binary communication protocol used for defining and creating services for programming languages.
...
* [Zig Proposals](https://github.com/ziglang/zig/issues?q=is:issue+is:open+label:proposal) ⭐ 43,332 | 🐛 2,857 | 🌐 Zig | 📅 2025-11-27 - Issues with Proposal label in Zig repository.
...
* [C# Design](https://github.com/dotnet/csharplang) ⭐ 12,679 | 🐛 285 | 🌐 C# | 📅 2026-08-12 - C# Language Design Proposals.
* [KEEP](https://github.com/Kotlin/KEEP) ⭐ 3,755 | 🐛 13 | 🌐 Markdown | 📅 2026-08-12 - Kotlin Evolution and Enhancement Process.
* [Go Proposals](https://github.com/golang/proposal) ⭐ 3,454 | 🐛 5 | 🌐 HTML | 📅 2026-08-07 - Design discussions for Go language evolution.
* [Dart Design](https://github.com/dart-lang/language) ⭐ 2,931 | 🐛 1,325 | 🌐 TeX | 📅 2026-08-12 - Design of the Dart language.
* [GHC Proposals](https://github.com/ghc-proposals/ghc-proposals) ⭐ 705 | 🐛 197 | 🌐 Python | 📅 2026-08-07 - Compiler and language changes for Haskell/GHC.
* [F# Design](https://github.com/fsharp/fslang-design) ⭐ 551 | 🐛 25 | 🌐 F# | 📅 2026-08-06 - F# Language Design RFCs.
...
* [React RFCs](https://github.com/reactjs/rfcs) ⭐ 5,799 | 🐛 52 | 📅 2024-06-11 - Change requests for React.
* [Vue RFCs](https://github.com/vuejs/rfcs) ⭐ 4,941 | 🐛 63 | 📅 2025-01-08 - Suggestions for major changes to Vue.js.
* [OTEPs](https://github.com/open-telemetry/opentelemetry-specification/tree/main/oteps/) ⭐ 4,304 | 🐛 577 | 🌐 Makefile | 📅 2026-08-12 - OpenTelemetry Enhancement Proposals.
...
* [OWASP MASVS](https://github.com/OWASP/owasp-masvs) ⭐ 2,426 | 🐛 3 | 🌐 Python | 📅 2025-12-22 - Mobile Application Security Verification Standard is the industry standard for mobile app security.
...
* [Awesome Guidelines](https://github.com/Kristories/awesome-guidelines) ⭐ 11,026 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-28 - Coding style conventions and standards.
