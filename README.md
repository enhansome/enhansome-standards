...
* [gRPC](https://github.com/grpc/grpc/blob/master/doc/PROTOCOL-HTTP2.md) ⭐ 45,227 | 🐛 1,370 | 🌐 C++ | 📅 2026-08-18 - This document serves as a detailed description for an implementation of gRPC carried over HTTP2 framing.
...
* [Apache Thrift](https://github.com/apache/thrift/tree/master/doc/specs) ⭐ 10,953 | 🐛 13 | 🌐 C++ | 📅 2026-08-17 - Interface Definition Language and binary communication protocol used for defining and creating services for programming languages.
* [CloudEvents Spec](https://github.com/cloudevents/spec) ⭐ 5,866 | 🐛 15 | 🌐 Python | 📅 2026-07-23 - A specification for describing event data in a common way.
...
* [Zig Proposals](https://github.com/ziglang/zig/issues?q=is:issue+is:open+label:proposal) ⭐ 43,315 | 🐛 2,852 | 🌐 Zig | 📅 2025-11-27 - Issues with Proposal label in Zig repository.
* [ECMAScript Proposals](https://github.com/tc39/proposals) ⭐ 19,175 | 🐛 9 | 📅 2026-08-04 - Ecma TC39 (Technical Committee 39) is responsible for evolving the ECMAScript programming language and authoring the specification.
* [C# Design](https://github.com/dotnet/csharplang) ⭐ 12,683 | 🐛 289 | 🌐 C# | 📅 2026-08-18 - C# Language Design Proposals.
* [KEEP](https://github.com/Kotlin/KEEP) ⭐ 3,758 | 🐛 13 | 🌐 Markdown | 📅 2026-08-18 - Kotlin Evolution and Enhancement Process.
...
* [OTEPs](https://github.com/open-telemetry/opentelemetry-specification/tree/main/oteps/) ⭐ 4,314 | 🐛 579 | 🌐 Makefile | 📅 2026-08-18 - OpenTelemetry Enhancement Proposals.
* [Compose Specification](https://github.com/compose-spec/compose-spec) ⭐ 2,720 | 🐛 18 | 🌐 Dockerfile | 📅 2026-08-17 - The Compose Specification is developer focused for defining cloud and platform agnostic container-based applications.
* [React Native RFCs](https://github.com/react-native-community/discussions-and-proposals) ⭐ 1,821 | 🐛 263 | 📅 2026-06-02 - React Native enhancement discussions.
...
* [BIPs](https://github.com/bitcoin/bips) ⭐ 10,919 | 🐛 52 | 🌐 Wikitext | 📅 2026-08-17 - Bitcoin Improvement Proposals.
...
* [NEPs](https://github.com/near/NEPs) ⭐ 238 | 🐛 12 | 📅 2026-08-18 - NEAR Protocol Specifications and Standards.
...
* [OWASP MASVS](https://github.com/OWASP/owasp-masvs) ⭐ 2,432 | 🐛 3 | 🌐 Python | 📅 2025-12-22 - Mobile Application Security Verification Standard is the industry standard for mobile app security.
